...
| **Ready (DoR ✅)** | **US-27** (refund on CONFIRMED cancel — FR-24) — mixed; extends `cancel_booking` (CONFIRMED + `stripe.Refund.create` przed status change) |
| **Backlog** | US-28 (M3) + US-29..US-43 (M4-M5) |
| **Done** | **US-01..US-26** ✅ (26 US) — M2 COMPLETE; M3 in progress (9/11; zostają US-27, US-28) |
