...
| **Ready (DoR ✅)** | **US-24** (Stripe Checkout integration) — **brainstorm-required** per `m3_planning.md` (replace `create_checkout_session` stub, `poetry add stripe`, `.env` keys, `BASE_URL`) |
| **Backlog** | US-25, US-27, US-28 (M3) + US-29..US-43 (M4-M5) |
| **Done** | **US-01..US-23 + US-26** ✅ (24 US) — M2 COMPLETE; M3 in progress (7/11; zostają US-24/25/27/28) |
