...
| **Ready (DoR ✅)** | **US-25** (Stripe webhook + StripeEvent idempotency) — **brainstorm-required** per `m3_planning.md` (`checkout.session.completed` → CONFIRMED, signature verify, StripeEvent dedupe, `STRIPE_WEBHOOK_SECRET`) |
| **Backlog** | US-27, US-28 (M3) + US-29..US-43 (M4-M5) |
| **Done** | **US-01..US-24 + US-26** ✅ (25 US) — M2 COMPLETE; M3 in progress (8/11; zostają US-25/27/28) |
